...
private struct FatThemeHTMLFactory<Site: Website>: HTMLFactory {
    ...
    func makeIndexHTML(
        ...
        HTML(
            ...
            .body(
                .class("index"),
                .header(for: context, selectedSection: Myblog.SectionID.index as? Site.SectionID),
                .wrapper(
        ...
        HTML(
            ...
            .body(
                ...
                .if(
                    ...
                    .header(
                        for: context,
                        selectedSection: Myblog.SectionID.about as? Site.SectionID
                    ),
...
extension Node where Context == HTML.BodyContext {
                ...
                .ul(
                    .forEach(sectionIDs) { section in
                        .li(
                            .a(
                                .if(
                                    section as! Myblog.SectionID
                                        == Myblog.SectionID.about,
                                    .class("selected")
                                ),
                                .class(section == selectedSection ? "selected" : ""),
                                .if(section as! Myblog.SectionID == Myblog.SectionID.index,
    ...
    fileprivate static func footer<T: Website>(for site: T) -> Node {
        ...
        return .footer(
            .p(
                .text("Copyright &copy; 陈斌 \(formatter.string(from: Date())) ")
            ),
            .p(
